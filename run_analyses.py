...
perform_analysis_completions('results/methods_pres_gpt-4-0314/methods_pres_gpt-4-0314_offense_recur.csv', 'results/methods_pres_follow_up_gpt-3.5-turbo-0301', None, 'GPT-4 Methods (Prescriptive, Offense Recurrence)', 'human_labels')